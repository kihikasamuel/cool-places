...
config :find_a_place, FindAPlaceWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "IAcMUipexx80BC0hqjh7ehfSFyB2/jGviHcwm+JN3XFc/Ha739vKlNh0a84E6JJO",
  watchers: [
...
config :find_a_place, FindAPlaceWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/find_a_place_web/(live|views)/.*(ex)$",
      ~r"lib/find_a_place_web/templates/.*(eex)$"
    ]
  ]
