...
#
#     PHX_SERVER=true bin/cool_places start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :cool_places, CoolPlacesWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :cool_places, CoolPlaces.Repo,
    ssl: [certfile: System.get_env("CERT_FILE_PATH")],
    url: database_url,
  ...
  config :cool_places, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
